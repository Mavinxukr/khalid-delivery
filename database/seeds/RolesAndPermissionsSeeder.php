...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user->assignRole('user');
        $user = App\User::whereEmail('edikcompanyfood@gmail.com')->first(); // enter your email here
        $user->assignRole('company');
        $user = App\User::whereEmail('edikcompanyservice@gmail.com')->first(); // enter your email here
        $user->assignRole('company');
        $user = App\User::whereEmail('company@gmail.com')->first(); // enter your email here
        $user->assignRole('company');
    }
